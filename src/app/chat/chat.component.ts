...
export class ChatComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.client.onConnect = (frame) => {
      ...
      this.client.subscribe('/chat/mensaje', m => {
          let mensaje: Mensaje = JSON.parse(m.body) as Mensaje;
      ...
      this.client.subscribe( '/chat/historial/' + this.clienteId, h => {
        const historial = JSON.parse(h.body) as Mensaje[];
